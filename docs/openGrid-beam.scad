...
module openGridbeam(
    ...
    // Board Connector Options
    Boardconnector_cutouts  = Boardconnector_cutouts,
    Boardconnector_Bottom_l = Boardconnector_Bottom_l,
    Boardconnector_Bottom_r = Boardconnector_Bottom_r,
    Boardconnector_Left_l   = Boardconnector_Left_l,
    Boardconnector_Left_r   = Boardconnector_Left_r,
    Boardconnector_Top_l    = Boardconnector_Top_l,
    Boardconnector_Top_r    = Boardconnector_Top_r,
    Boardconnector_Right_l  = Boardconnector_Right_l,
    Boardconnector_Right_r  = Boardconnector_Right_r,

    // Beam Connector Options
    Beamconnector_cutouts   = Beamconnector_cutouts,
    Beamconnector_Bottom_l  = Beamconnector_Bottom_l,
    Beamconnector_Bottom_r  = Beamconnector_Bottom_r,
    Beamconnector_Left_l    = Beamconnector_Left_l,
    Beamconnector_Left_r    = Beamconnector_Left_r,
    Beamconnector_Top_l     = Beamconnector_Top_l,
    Beamconnector_Top_r     = Beamconnector_Top_r,
    Beamconnector_Right_l   = Beamconnector_Right_l,
    Beamconnector_Right_r   = Beamconnector_Right_r,

    // Joint Options
    Joints              = Joints,
    Joint_Bottom_l      = Joint_Bottom_l,
    Joint_Bottom_r      = Joint_Bottom_r,
    Joint_Left_l        = Joint_Left_l,
    Joint_Left_r        = Joint_Left_r,
    Joint_Top_l         = Joint_Top_l,
    Joint_Top_r         = Joint_Top_r,
    Joint_Right_l       = Joint_Right_l,
    Joint_Right_r       = Joint_Right_r,
    Joint_attached      = Joint_attached,

    // Chamfer Options
    Chamfers            = Chamfers,
    Chamfer_Bottom_l    = Chamfer_Bottom_l,
    Chamfer_Bottom_r    = Chamfer_Bottom_r,
    Chamfer_Left_l      = Chamfer_Left_l,
    Chamfer_Left_r      = Chamfer_Left_r,
    Chamfer_Top_l       = Chamfer_Top_l,
    Chamfer_Top_r       = Chamfer_Top_r,
    Chamfer_Right_l     = Chamfer_Right_l,
    Chamfer_Right_r     = Chamfer_Right_r,
...
// openGridbeam(Board_Width=Board_Width, Board_Height=Board_Height);
